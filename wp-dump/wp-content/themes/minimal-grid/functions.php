...
function minimal_grid_scripts() {
    ...
    wp_enqueue_style('perfect-scrollbar', get_template_directory_uri() . '/assets/lib/perfect-scrollbar/css/perfect-scrollbar.css');
    ...
    wp_enqueue_script('jquery-perfect-scrollbar', get_template_directory_uri() . '/assets/lib/perfect-scrollbar/js/perfect-scrollbar' . $min . '.js', array('jquery'), '', true);
